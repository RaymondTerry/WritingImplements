...
public class WritingImplements
{
	public static void main(String[] args)
	{
      ...
      Highlighter standard = new Highlighter("yellow", "bullet");
      Highlighter girly = new Highlighter("pink", "chisel");

		myPurplePen.write("I'm hungry");
      standard.highlight("Over the words");
      standard.write("I can highlight things.");
      ...
      myPencilBox.add(standard);
		myPencilBox.add(girly);
